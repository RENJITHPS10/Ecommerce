...
//   return (
//     <section className="px-6 md:px-20 py-16 bg-gray-50 text-gray-800">
//       <h1 className="text-4xl font-extrabold mb-4 text-center text-gray-900">
//         Contact Us
//       </h1>
//       <p className="text-center max-w-xl mx-auto mb-12 text-gray-600">
...
//         {[
//           { icon: <Mail className="mx-auto mb-3" />, title: "Email", text: "support@Myshop.com" },
//           { icon: <Phone className="mx-auto mb-3" />, title: "Phone", text: "+91 62380 57379" },
//           { icon: <MapPin className="mx-auto mb-3" />, title: "Address", text: "Kochi, Kerala" },
//         ].map((card, idx) => (
//           <div
//             key={idx}
//             className="p-6 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300"
//           >
...
//             <button
//               type="submit"
//               className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl shadow-lg hover:scale-105 transition-transform duration-200 font-semibold"
//             >
