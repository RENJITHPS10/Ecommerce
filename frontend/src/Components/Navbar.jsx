...
//   return (
//     <div className="flex items-center justify-between py-5 px-6 sm:px-10 bg-white shadow-sm relative z-50">
//       <Link to="/">
//         <img src={logos} className="w-36" alt="MyShop Logo" />
//       </Link>

//       <ul className="hidden sm:flex gap-6 text-sm text-gray-700">
//         <NavLink to="/" className="hover:text-blue-600 transition">HOME</NavLink>
//         <NavLink to="/collection" className="hover:text-blue-600 transition">COLLECTION</NavLink>
...
//             <User className="w-5 h-5 text-gray-700 hover:text-red-500 transition" />
//             <ChevronDown className={`w-4 h-4 text-gray-700 transition-transform ${openUser ? "rotate-180" : ""}`} />
//           </div>

//           {openUser && (
//             <div className="absolute right-0 top-6 bg-white border rounded-lg shadow-lg py-3 px-4 w-40 flex flex-col gap-2 z-[9999]">
//               {user ? (
//                 <>
//                   <Link to="/order" onClick={() => setOpenUser(false)} className="hover:text-black">Orders</Link>
//                   <button onClick={handleLogout} className="text-left hover:text-black">Logout</button>
//                 </>
//               ) : (
//                 <Link to="/login" onClick={() => setOpenUser(false)} className="hover:text-black">Login</Link>
//               )}
//             </div>
//           )}
//         </div>
...
//           <ShoppingCart className="w-5 h-5 cursor-pointer hover:text-red-500 transition" />
//           {totalQuantity > 0 && (
//             <motion.span
//               initial={{ scale: 0 }}
//               animate={{ scale: [1, 1.3, 1] }}
//               transition={{ duration: 0.4 }}
//               className="absolute -top-2 -right-2 w-4 h-4 bg-red-600 text-white text-[10px] flex items-center justify-center rounded-full font-semibold shadow-sm"
//             >
//               {totalQuantity}
//             </motion.span>
//           )}
...
//         <Menu onClick={() => setVisible(true)} className="w-6 h-6 cursor-pointer hover:text-red-500 transition sm:hidden" />
//       </div>

      
//       {visible && <div className="fixed inset-0 bg-black/40 z-[9998]" onClick={() => setVisible(false)}></div>}

//       <div className={`fixed top-0 left-0 h-full bg-white shadow-lg w-64 z-[9999] p-6 transform transition-transform ${visible ? "translate-x-0" : "-translate-x-full"}`}>
//         <div className="flex justify-between items-center mb-4">
//           <img src={logos} className="w-28" alt="mobile-logo" />
//           <X className="w-6 h-6 cursor-pointer" onClick={() => setVisible(false)} />
//         </div>
...
//           {user ? (
//             <>
//               <NavLink to="/orders" onClick={() => setVisible(false)}>Orders</NavLink>
//               <button onClick={() => { handleLogout(); setVisible(false); }} className="text-left">Logout</button>
//             </>
//           ) : (
